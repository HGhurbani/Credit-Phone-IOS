...
class ApiService {
  ...
  Future<Map<String, dynamic>> createOrder({
    ...
    String orderNotes = "Product purchase inquiry\n";
    orderNotes += "\nNew Customer: ${isNewCustomer ? 'Yes' : 'No'}";
    if (customerNote?.isNotEmpty ?? false) {
      orderNotes += "\n\nCustomer Note: $customerNote";
    }
    orderNotes +=
        "\n\nThis request is a purchase inquiry. Order completion is handled by the team outside the app.";

    final metaData = [
      {'key': 'request_type', 'value': 'product_inquiry'},
