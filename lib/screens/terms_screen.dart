          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildParagraph(
                  isAr
                      ? 'باستخدامك للتطبيق، فإنك توافق على الالتزام بالشروط والأحكام الموضحة أدناه. يرجى قراءة هذه الشروط بعناية قبل استخدام التطبيق.'
                      : 'By using the app, you agree to be bound by the terms and conditions outlined below. Please read these terms carefully before using the application.',
                  textDirection,
                ),
                ...
                _buildBulletPoint(
                  isAr
                      ? 'يُستخدم هذا التطبيق لعرض المنتجات المتاحة وتقديم طلبات شراء مبدئية، وقد يتم استكمال بعض خطوات التواصل أو التأكيد خارج التطبيق مثل واتساب أو التواصل المباشر مع فريقنا.'
                      : 'This application is used to display available products and submit preliminary purchase inquiries. Some communication or confirmation steps may be completed outside the app, such as via WhatsApp or direct contact with our team.',
                  textDirection,
                ),
                _buildBulletPoint(
                  isAr
                ...
                _buildBulletPoint(
                  isAr
                      ? 'يعتبر الطلب المقدم عبر التطبيق طلباً مبدئياً وغير ملزم حتى يتم تأكيده بشكل رسمي من قبل فريقنا عبر محادثة واتساب.'
                      : 'An order placed through the application is considered an initial, non-binding request until it is officially confirmed by our team via a WhatsApp conversation.',
                  textDirection,
                ),
                _buildBulletPoint(
                  isAr
                ...
                _buildBulletPoint(
                  isAr
                      ? 'قد يتواصل فريقنا معك لتأكيد توفر المنتج وتفاصيل الطلب قبل إتمامه.'
                      : 'Our team may contact you to confirm product availability and order details before completion.',
                  textDirection,
                ),
                const SizedBox(height: 20),
                ...
                _buildParagraph(
                  isAr
                      ? 'هذا التطبيق هو كتالوج منتجات يتيح للعملاء تصفح الأجهزة الإلكترونية وإرسال طلبات شراء.'
                      : 'This application is a product catalog that lets customers browse electronics and submit purchase inquiries.',
                  textDirection,
                ),
