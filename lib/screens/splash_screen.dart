...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  final List<Map<String, String>> arContent = [
    {
      'title': 'كتالوج منتجاتك في قطر',
      'desc':
      'تصفح الجوالات والأجهزة الإلكترونية وأرسل طلب شراء بسهولة.\nسيتواصل معك فريقنا لتأكيد التوفر وتفاصيل الطلب.',
    },
    {
      'title': 'اطلب المنتج المناسب',
      'desc':
      'أضف المنتجات إلى السلة وأرسل طلبك.\nيتم استكمال الطلب عبر فريقنا خارج التطبيق.',
    },
    {
      'title': 'تواصل لإتمام الطلب',
      'desc':
      'فريقنا يؤكد تفاصيل الطلب والتوفر وطريقة الاستلام أو التوصيل.',
    },
  ];

  final List<Map<String, String>> enContent = [
    {
      'title': 'CreditPhone in Qatar',
      'desc':
      'Browse mobiles and electronics and submit a purchase inquiry easily.\nOur team will contact you to confirm availability and order details.',
    },
    {
      'title': 'Request the Right Product',
      'desc':
      'Add products to your cart and submit your request.\nOrder completion is handled by our team outside the app.',
    },
    {
      'title': 'Contact Us to Complete',
      'desc':
      'Our team confirms order details, availability, and pickup or delivery options.',
    },
  ];
