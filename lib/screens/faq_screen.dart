...
class FaqScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final faqs = [
      {
        "q": isAr ? "كم يستغرق تأكيد الطلب؟" : "How long does order confirmation take?",
        "a": isAr ? "سيتواصل معك فريقنا بعد إرسال الطلب لتأكيد توفر المنتج وتفاصيل الطلب." : "Our team will contact you after submission to confirm product availability and order details."
      },
      {
      ...
      {
        "q": isAr ? "هل يطلب التطبيق مستندات مالية؟" : "Does the app request financial documents?",
        "a": isAr
            ? "لا. يتيح التطبيق تصفح المنتجات وإرسال طلب شراء فقط. لا نطلب راتباً أو بيانات بنك أو مستندات هوية داخل التطبيق."
            : "No. The app only lets you browse products and submit purchase inquiries. It does not request salary, bank details, or identity documents in the app."
      },
      {
